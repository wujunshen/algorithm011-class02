 ...
 * <p>示例 1:
 *
 * <p>输入: m = 3, n = 2 输出: 3 解释: 从左上角开始，总共有 3 条路径可以到达右下角。 1. 向右 -> 向右 -> 向下 2. 向右 -> 向下 -> 向右 3. 向下
 * -> 向右 -> 向右 示例 2:
 *
 * <p>输入: m = 7, n = 3 输出: 28
 *
 * <p>提示：
 *
 * <p>1 <= m, n <= 100 题目数据保证答案小于等于 2 * 10 ^ 9
 *
 * <p>来源：力扣（LeetCode） 链接：https://leetcode-cn.com/problems/unique-paths
